const OPPONENT_HEIGHT = 5,
    ...
    SHOT_WIDTH = 1.5,
    BOSS_HEIGHT = 5,
    BOSS_PICTURE = "assets/jefe.png",               // ALUMNA
    BOSS_PICTURE_DEAD = "assets/jefe_muerto.png",   // ALUMNA
    BOSS_SPEED = 10,                                // ALUMNA
    BOSS_WIDTH = 5,                                 // ALUMNA
    YOU_WIN_PICTURE = "assets/you_win.png";         // ALUMNA
